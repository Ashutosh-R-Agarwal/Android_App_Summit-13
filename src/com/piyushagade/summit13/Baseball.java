...
public class Baseball extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sport Specific Code //
		rule1.setText("1. Each team will have to pay for balls.");
		rule2.setText("2. Maximum of 16 players.");
		rule3.setText("3. Maximum of 16 players.");
		rule4.setText("4. Catcher's kit and batters helmets are compulsory.");
		rule5.setText("");
		rule6.setText("");
		number1.setText("Akash Gandham: 8446324939");
		number2.setText("");
		money.setText("Men: Rs. 800");
		sport.setText("Baseball");
