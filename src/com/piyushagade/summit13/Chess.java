...
public class Chess extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sport Specific Code //
		rule1.setText("1. Maximum of 5 players allowed in the team.");
		rule2.setText("2. Chess boards and chess clock is to be brought by players.");
		rule3.setText("");
		rule4.setText("");
		rule5.setText("");
		rule6.setText("");
		number1.setText("Vedant: 9158392263");
		number2.setText("");
