...
public class Basketball extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sport Specific Code //
		rule1.setText("1. Maximum of 12 players are allowed to participate.");
		rule2.setText("2. Incase of a tie 5 minutes of extra time will be allotted.");
		rule3.setText("");
		rule4.setText("");
		rule5.setText("");
		rule6.setText("");
		number1.setText("(Men) Mukul More: 9970977377");
		number2.setText("(Women) Devika Agashe: 9011529959");
		money.setText("Men: Rs. 1000, Women: Rs. 800");
