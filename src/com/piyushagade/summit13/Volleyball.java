...
public class Volleyball extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rule2.setText("2. Colours compulsory.");
		rule3.setText("");
		rule4.setText("");
		rule5.setText("");
		rule6.setText("");
		number1.setText("(Men) Pawan Chandukar: 8446996867");
		number2.setText("(Women) Sammiti Yadav: 9561722955");
