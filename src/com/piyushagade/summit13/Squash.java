...
public class Squash extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sport Specific Code //
		rule1.setText("1. Maximum 5 players allowed in the team.");
		rule2.setText("2. Squash balls will be provided");
		rule3.setText("");
		rule4.setText("");
		rule5.setText("");
		rule6.setText("");
		number1.setText("Abhishek Santosh: 9623716283");
		number2.setText("");
		money.setText("Men: Rs. 600");
		sport.setText("Squash");
