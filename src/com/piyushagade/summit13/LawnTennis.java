...
public class LawnTennis extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Sport Specific Code //
		rule1.setText("1. Minimum players for men: 2, max: 4.");
		rule2.setText("2. Two singles and one doubles match will be played.");
		rule3.setText("");
		rule4.setText("");
		rule5.setText("");
		rule6.setText("");
		number1.setText("Varun Date: 9730171606");
		number2.setText("");
		money.setText("Rs. 900");
		sport.setText("Lawn Tennis");
